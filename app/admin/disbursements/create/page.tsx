...
export default function CreateDisbursement() {
    ...
    const [formData, setFormData] = useState({
        description: '',
        amount: 0,
        disbursement_date: new Date().toISOString().slice(0, 16), // datetime-local
        recipient: '',
        method: 'Tunai', // 'Tunai' or 'Transfer'
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-2xl font-bold text-slate-800">Catat Penyaluran Baru</h1>
            </div>
